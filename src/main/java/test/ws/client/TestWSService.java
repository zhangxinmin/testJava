 ...
 * 
 */
@WebServiceClient(name = "TestWSService", targetNamespace = "http://ws.test/", wsdlLocation = "http://127.0.0.1:8888/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTWSSERVICE_QNAME = new QName("http://ws.test/", "TestWSService");
    ...
    public TestWS getTestWSPort() {
        return super.getPort(new QName("http://ws.test/", "TestWSPort"), TestWS.class);
    }
    ...
    public TestWS getTestWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.test/", "TestWSPort"), TestWS.class, features);
    }
